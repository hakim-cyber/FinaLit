...
new_keys = [
    ("debtSubtitle", "We use this to balance payoff strategy with savings goals.", "Ödəniş strategiyasını yığım hədəfləri ilə balanslaşdırmaq üçün bundan istifadə edirik."),
    ("personalInfoSubtitle", "We use this to personalize your financial assistant.", "Bunu maliyyə köməkçinizi fərdiləşdirmək üçün istifadə edirik.")
]
...
replacements = {
    '"We use this to balance payoff strategy with savings goals."': 'String(localized: "onboarding.debtSubtitle")',
    '"We use this to personalize your financial assistant."': 'String(localized: "onboarding.personalInfoSubtitle")'
}
