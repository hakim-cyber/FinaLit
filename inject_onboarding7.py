...
new_keys = [
    ("riskSubtitle", "We'll keep recommendations aligned with your comfort level.", "Tövsiyələri sizin risk səviyyənizə uyğunlaşdıracağıq.")
]
...
print("Injected Onboarding.riskSubtitle keys successfully.")

ROOT = "/Users/aplle/Desktop/swift learning/FinaLit/FinaLit/Features/Onboarding"

replacements = {
    '"We\'ll keep recommendations aligned with your comfort level."': 'String(localized: "onboarding.riskSubtitle")'
}
