...
new_keys = [
    ("employmentSubtitle", "This helps us estimate realistic monthly cash flow.", "Bu bizə realist aylıq nağd pul dövriyyəsini təxmin etməyə kömək edir.")
]
...
print("Injected Onboarding.employmentSubtitle keys successfully.")

ROOT = "/Users/aplle/Desktop/swift learning/FinaLit/FinaLit/Features/Onboarding"

replacements = {
    '"This helps us estimate realistic monthly cash flow."': 'String(localized: "onboarding.employmentSubtitle")'
}
